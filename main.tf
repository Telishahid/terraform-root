...
# ── VPC ──────────────────────────────────────────────────────────────
module "vpc" {
  source = "git::https://github.com/Telishahid/terraform-module-vpc.git"
...
module "subnets" {
  source = "git::https://github.com/Telishahid/terraform-module-subnet.git"
...
module "ec2_instances" {
  source = "git::https://github.com/Telishahid/terraform-module-ec2.git"
